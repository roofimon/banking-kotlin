 ...
 *
 * Used in two places:
 * 1. **Use case guard** — [com.bank.memebank88.banking.application.usecase.TransferMoneyUseCase]
 *    calls [isServiceAvailable] with `LocalTime.now()` at the start of every transfer when a
 *    `TimeServicePort` has been wired via
 *    [com.bank.memebank88.banking.port.inbound.TransferUseCase.setTimeService].
 *    If unavailable, the use case throws
 *    [com.bank.memebank88.banking.application.exception.OutOfServiceException].
 * 2. **AOP interceptor** — [com.bank.memebank88.banking.adapter.outbound.service.CheckingTimeAdvice]
 ...
 *
 * Known adapters:
 * - [com.bank.memebank88.banking.adapter.outbound.service.DefaultTimeService]
...
interface TimeServicePort {
     ...
     * - The use case throws [com.bank.memebank88.banking.application.exception.OutOfServiceException].
     * - The AOP advice ([com.bank.memebank88.banking.adapter.outbound.service.CheckingTimeAdvice])
     *   also throws [com.bank.memebank88.banking.application.exception.OutOfServiceException] and
