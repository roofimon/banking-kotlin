 ...
 *
 * Known inbound adapters: [com.bank.memebank88.adapter.inbound.web.AccountController]
 *
 * Outbound dependencies wired into the implementation:
 * - [com.bank.memebank88.port.outbound.AccountRepositoryPort] — account persistence
 * - [com.bank.memebank88.port.outbound.FeePolicyPort] — fee calculation strategy
 * - [com.bank.memebank88.port.outbound.TimeServicePort] — optional service-hours guard
 */
interface TransferUseCase {
     ...
     * 2. If a [com.bank.memebank88.port.outbound.TimeServicePort] is wired,
     ...
     * [com.bank.memebank88.port.outbound.TimeServicePort.isServiceAvailable]
     ...
     */
    fun setTimeService(timeService: com.bank.memebank88.port.outbound.TimeServicePort)
}
