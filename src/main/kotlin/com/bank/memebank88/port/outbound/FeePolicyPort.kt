 ...
 * [com.bank.memebank88.application.usecase.TransferMoneyUseCase] at construction time.
 *
 * Known adapters:
 * - [com.bank.memebank88.adapter.outbound.service.ZeroFeePolicy]
 *   — always returns `0.0`; used for free-transfer scenarios and most unit tests.
 * - [com.bank.memebank88.adapter.outbound.service.FlatFeePolicy]
 *   — charges a fixed amount per transfer (default **$5.00**), regardless of size.
 * - [com.bank.memebank88.adapter.outbound.service.VariableFeePolicy]
